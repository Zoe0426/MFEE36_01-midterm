                ...
                <div class="col-10 mb-3 s_spec">
                    <div class="row">
                        <div class="col-4">
                            ...
                            <select class="form-select s_specific_sid" name="specific_sid" data-required="1">
...
<script>
    ...
    function checkForm(event) {
        ...
        if (isPass) {
            ...
            fetch('s_proSpecAdd-api_update.php', {
                    method: 'POST',
                    body: fd,
                }).then(r => r.json())
                .then(obj => {
    ...
    //==================商品規格自動生成==================
    const specSel = document.querySelector('.s_specific_sid')
    ...
    specSel.addEventListener('change', () => {
        ...
        if (specSelId <= counted) {
            ...
            theInput.setAttribute('name', 'detail_name')
            ...
            theInput1.setAttribute('name', 'detail_name')
    ...
    function createTable(specSelId) {
        ...
        theTh.innerHTML = '現有' + arr[0].name + '列表';
        theThr.append(theTh)
        ...
        for (let i = 0, imax = arr.length; i < imax; i += 5) {
            ...
            for (let j = i, max = i + 5; j < max; j++) {
                ...
                const theTxt = document.createTextNode(arr[j]?.detail_name || "")
                theTd.append(theTxt)
                theTr.append(theTd)
            }
