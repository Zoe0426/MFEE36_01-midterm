...
// echo "$member_sid,$board_sid,$post_title,$post_content,$head_image,$post_date,$post_type,$pet_sid";
...
//     $file = sha1($_FILES['file']['name']. uniqid()). '.jpg'; //先把file名字編碼過
//     move_uploaded_file($_FILES['file']['tmp_name'], "./imgs/{$file}"); //把圖片存到img檔案裡
