        ...
        <form class="pt-4" name="s_Form3" onsubmit="checkForm(event)">
            ...
            <div class="row pb-3 border-bottom">
                <div class="col-5">
                    ...
                    <input type="text" name="img" id="s_proImg">
                </div>
                <div class="col-7">
                    <div class="mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select" name="category_sid" id="s_category_sid" data-required="1">
                                    ...
                                    <?php foreach ($r_shopCat as $r) : ?>
                                        <option value="<?= $r['category_sid'] ?>"><?= $r['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-6">
                                <label class="form-label" for="s_category_detail_sid">細項類別</label>
                                <select class="form-select" name="category_detail_sid" id="s_category_detail_sid" disabled></select>
                            </div>
                        </div>
                        <div class="form-text"></div>
                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <select class="form-select" name="supplier_sid" id="s_supplier_sid" data-required="1">
                                    ...
                                    <?php foreach ($r_shopSup as $r) : ?>
                                        <option value="<?= $r['supplier_sid'] ?>"><?= $r['name'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-6">
                                <label class="form-label" for="s_made_in_where">製造地</label>
                                <select class="form-select" name="made_in_where" id="s_made_in_where" disabled></select>
                            </div>
                        </div>
                        <div class="form-text"></div>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" data-required="1"></textarea>
                        <div class="form-text"></div>
                    </div>
                </div>
            </div>
            <div class="row pb-3 border-bottom mt-4" id="s_proDetBox">
                <div class="col-3 mb-3">
                    <div class="mb-3 s_proDetNum">
                        <input type="text" class="form-control " name="product_detail_sid[]" value="1">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 s_spec">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <select class="form-select s_specific_sid2" name="specific_sid2[]" disabled>
                                    <option value="" selected disabled>--請選擇--</option>
                                </select>
                            </div>
                            <div class="col-6">
...
<script>
    ...
    function createSup() {
        location.href = 's_supAdd_update.php'
    }
