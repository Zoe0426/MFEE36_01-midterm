...
<script>
    ...
    adminSelect.addEventListener('change', function() {
        ...
        if (adminVal == 'Lilian') {
            window.location.href = 'p_readPost_Ltest.php?admin=Lilian';
        }
        if (adminVal == 'Jenny') {
            window.location.href = 'p_readPost_Ltest.php?admin=Lilian';
        }
    ...
    search.addEventListener('click', function() {
        ...
        location.href = 'p_readPost_Ltest.php?text=' + keywordVal;
    })
    ...
    boardSelect.addEventListener('change', function() {
        ...
        location.href = 'p_readPost_Ltest.php?boardSid=' + boardSid;
    });
</script>
