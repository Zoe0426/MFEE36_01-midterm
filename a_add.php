...
<form name="form1" onsubmit="checkForm(event)">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" name="group_time" data-required="1">
            <option selected>--請選擇--</option>
...
<script>
    ...
    function checkForm(event) {
        ...
        for (let f of fields) {
            ...
            f.nextElementSibling.innerHTML = '這裡有東西';
        }
        ...
        if (nameField.value.length < 2) {
            ...
            // typeSid.style.border = '1px solid red';
            // typeSid.nextElementSibling.innerHTML = '請選擇'
            ...
            content.nextElementSibling.innerHTML = '請輸入活動內容'

            policy.style.border = '1px solid red';
            policy.nextElementSibling.innerHTML = '請輸入活動規範'
